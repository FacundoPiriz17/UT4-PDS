...
public class ElementoAB<T> implements IElementoAB<T> {
    ...
    public boolean encuentraLinealUno(String nombreAtributo, Comparable valorAtributo) {
        boolean encontrado = (this.etiqueta.compareTo(valorAtributo) == 0);
        if (hijoIzq != null) {
            encontrado |= hijoIzq.encuentraLinealUno(nombreAtributo, valorAtributo);
        }
        if (hijoDer != null) {
            encontrado |= hijoDer.encuentraLinealUno(nombreAtributo, valorAtributo);
        }
        return encontrado;
    }


    public boolean encuentraLinealDos(String nombreAtributo, Comparable valorAtributo) {
        if (this.etiqueta.compareTo(valorAtributo) == 0) {
            return true;
        }
        if (hijoIzq != null && hijoIzq.encuentraLinealDos(nombreAtributo, valorAtributo)) {
            return true;
        }
        if (hijoDer != null && hijoDer.encuentraLinealDos(nombreAtributo, valorAtributo)) {
            return true;
        }
        return false;
    }
    ...
    public IElementoAB<T> encuentraLinealTres(String nombreAtributo, Comparable valorAtributo) {
        if (this.etiqueta.compareTo(valorAtributo) == 0) {
            return this;
        }
        IElementoAB<T> result = null;
        if (hijoIzq != null) {
            result = hijoIzq.encuentraLinealTres(nombreAtributo, valorAtributo);
            if (result != null) {
                return result;
            }
        }
        if (hijoDer != null) {
            result = hijoDer.encuentraLinealTres(nombreAtributo, valorAtributo);
        }
        return result;
    }
