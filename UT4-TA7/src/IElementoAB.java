...
public interface IElementoAB<T> {
    ...
    IElementoAB<T> encuentraLinealTres(String nombreAtributo, Comparable valorAtributo);

    boolean encuentraLinealDos(String nombreAtributo, Comparable valorAtributo);

    boolean encuentraLinealUno(String nombreAtributo, Comparable valorAtributo);
}