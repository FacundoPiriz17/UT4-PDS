...
public class ArbolBB<T> implements IArbolBB<T> {
    ...
    // Ejercicio 5.1
    public boolean encuentraLinealUno(String nombreAtributo, Comparable etiqueta) {
        if (raiz != null) {
            return raiz.encuentraLinealUno(nombreAtributo, etiqueta);
        }
        return false;
    }

    // Ejercicio 5.2
    public boolean encuentraLinealDos(String nombreAtributo, Comparable etiqueta) {
        if (raiz != null) {
            return raiz.encuentraLinealDos(nombreAtributo, etiqueta);
        }
        return false;
    }

    // Ejercicio 5.3
    public IElementoAB<T> encuentraLinealTres(String nombreAtributo, Comparable etiqueta) {
        if (raiz != null) {
            return raiz.encuentraLinealTres(nombreAtributo, etiqueta);
        }
        return null;
    }
